...
class ModuleHelper(VhdlHelper):
    ...
    def conditionCorrelationCombinations(self, condition):
        """Return dictionary of correlation combination for condition. If
    ...
    def conditioncorrelationCombinationsTbpt(self, condition):
        ...
        if isinstance(condition, CaloConditionHelper):
            ...
            combinations[key] = (CorrelationObjectHelper(a), CorrelationObjectHelper(a))
...
if __name__ == '__main__':
    ...
    if args.m:
        ...
        for module in menu.modules:
            ...
            print("module.correlationCombinationsCosDphi:")
            ...
            for a, b in module.correlationCombinationsTbpt:
                print(" ", a.type, a.bx, "<>", b.type, b.bx)
            print("-" * 80)
